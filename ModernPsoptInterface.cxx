...
/// Datastructure for the relevant PSOPT structures
struct ModernPsoptInterface::PsoptDataStruct {
	Alg  algorithm;
	Sol  solution;
	Prob problem;
};
...
ModernPsoptInterface::ModernPsoptInterface(): psoptData(new PsoptDataStruct()) {}
